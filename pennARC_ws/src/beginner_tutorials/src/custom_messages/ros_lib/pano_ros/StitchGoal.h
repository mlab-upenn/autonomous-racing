...
namespace pano_ros
{
  ...
  {
    public:
      const char* bag_file_name;
      const char* stitch_file_name;
    ...
    {
      int offset = 0;
      uint32_t length_bag_file_name = strlen(this->bag_file_name);
      ...
      uint32_t length_stitch_file_name = strlen(this->stitch_file_name);
