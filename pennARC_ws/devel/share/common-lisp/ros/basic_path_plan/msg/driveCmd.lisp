...
(cl:in-package basic_path_plan-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <driveCmd>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'driveCmd)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name basic_path_plan-msg:<driveCmd> is deprecated: use basic_path_plan-msg:driveCmd instead.")))

(cl:ensure-generic-function 'steering-val :lambda-list '(m))
(cl:defmethod steering-val ((m <driveCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader basic_path_plan-msg:steering-val is deprecated.  Use basic_path_plan-msg:steering instead.")
  (steering m))

(cl:ensure-generic-function 'throttle-val :lambda-list '(m))
(cl:defmethod throttle-val ((m <driveCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader basic_path_plan-msg:throttle-val is deprecated.  Use basic_path_plan-msg:throttle instead.")
  (throttle m))
