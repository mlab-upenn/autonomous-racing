...
if("TRUE" STREQUAL "TRUE")
  set(camera1394_SOURCE_PREFIX /home/dhruva/Documents/mlab/autonomous-racing/pennARC_ws/src/camera1394)
  set(camera1394_DEVEL_PREFIX /home/dhruva/Documents/mlab/autonomous-racing/pennARC_ws/devel)
  ...
  set(camera1394_INSTALL_PREFIX /home/dhruva/Documents/mlab/autonomous-racing/pennARC_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'camera1394' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Jack O'Quin <jack.oquin@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'camera1394' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dhruva/Documents/mlab/autonomous-racing/pennARC_ws/src/camera1394/${idir}'.  Ask the maintainer 'Jack O'Quin <jack.oquin@gmail.com>' to fix it.")
    endif()
...
set(camera1394_EXPORTED_TARGETS "camera1394_generate_messages_cpp;camera1394_generate_messages_lisp;camera1394_generate_messages_py;camera1394_gencfg")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${camera1394_dep}_FOUND)
      find_package(${camera1394_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${camera1394_dep} REQUIRED ${depend_list})
  endif()
